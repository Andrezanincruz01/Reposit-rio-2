...
def F(x):
    ...
    Entrada: x ∈ R⁴
    Saída  : [f1, f2]
      f1 = 2·x0 + sqrt(2)·x1 + sqrt(2)·x2 + x3
      f2 = 2/x0 + 2sqrt(2)/x1 + 2sqrt(2)/x2 + 2/x3
    """
...
# ==========================================================
# Definição de F e de seus gradientes
# ==========================================================
...
def TRIDIAgrad(x):
    """
    Retorna (gradf1, gradf2, gradf3), cada qual em ℝ³.
    """
...
# ==========================================================
#Funções auxiliares: Armijo, A_k, projeção, etc.
# ==========================================================
