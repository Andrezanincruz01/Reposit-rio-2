...
# ============================================
np.random.seed(42)                      # ← torna a lista reprodutível
...
for alpha in alpha_values:
    ...
    # ===========================================================
    # 2) MULTI-START: roda o AL+PGM a partir de cada proj_z
    # ===========================================================
    for i, (z0_raw, z0) in enumerate(zip(raw_inits, proj_inits), 1):
        ...
        print("Ponto bruto (antes proj.):", np.round(z0_raw, 4))     # novo
...
def solve_weighted(alpha, lam):
    ...
    mdl.parameters.timelimit = 30       #CPLEX encerra a busca quando atinge 30 s, mesmo que não tenha provado otimalidade
    t0 = time.time()
...
# ================================================================
# Loop sobre cada α para calcular HV, spread, card, Δcard e Purity
# ================================================================
for α in alpha_values:
